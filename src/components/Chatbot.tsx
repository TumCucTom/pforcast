  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m your financial planning assistant. I can help you with budgeting advice, investment strategies, tax planning, and general financial questions. How can I help you today?',
      timestamp: new Date()
    }
  ])
